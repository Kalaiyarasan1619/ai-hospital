...
const PatientDetailsEdit = () => {
  ...
  console.log(patientId, "Edit Patiet ID")
  ...
  useEffect(() => {
    const fetchPatientData = async () => {
      try {
        ...
        if (patientData.validUntil) {
          const date = new Date(patientData.validUntil);
          patientData.validUntil = date.toISOString().split('T')[0];
        }
        
        if (patientData.profileImage) {
          setProfileImage(patientData.profileImage);
        }
  ...
  const getTabCompletionStatus = (tabId) => {
    switch(tabId) {
      ...
      case 'contact':
        return formData.phoneNumber && formData.address && formData.city && formData.state && formData.pincode;
      case 'medical':
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="text-white">
                ...
                <p className="text-sky-100 mt-1">Update patient information in the system</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-8 border-b">
            <div className="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-gray-600 mb-4">Update the patient photo if needed</p>
      ...
      {showSuccess && (
        <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-8 text-center transform scale-100 transition-all duration-300">
            ...
            <h3 className="text-3xl font-bold text-gray-800 mb-3">Changes Saved!</h3>
            <p className="text-gray-600 mb-8 text-lg">
              Patient details have been updated successfully. Redirecting to patient profile...
            </p>
